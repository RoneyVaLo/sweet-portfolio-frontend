...
export function Footer() {
  ...
  return (
    <footer id="contacto" className="bg-cacao text-cream py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-cream/80 leading-relaxed">
              Dulzura artesanal en cada bocado. Creamos momentos memorables a
              través de nuestros postres hechos con amor.
            </p>
          </div>
          ...
          <div className="text-center md:text-right">
            <h4 className="font-serif text-xl font-semibold mb-4">Contacto</h4>
            <div className="space-y-3">
              <a
                href={whatsappLink || "#"}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center text-cream/80 hover:text-emerald-light transition-colors duration-300"
              >
                <svg
              ...
              <div className="flex justify-center md:justify-end gap-4 pt-4">
                <a
                  href={instagramUrl || "#"}
                  className="w-10 h-10 rounded-full bg-cream/10 flex items-center justify-center hover:bg-emerald transition-colors duration-300"
